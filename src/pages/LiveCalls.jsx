    ...
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">Real-time active calls on your Asterisk server</p>
        </div>
          ...
          >
            ...
            <div className="flex-1 grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
              <div>
                ...
                <p className="font-medium text-gray-900 mt-0.5">{call.caller}</p>
              </div>
              <div>
                <p className="text-xs text-gray-400 uppercase tracking-wide">DID</p>
                <p className="font-medium text-gray-900 mt-0.5">{call.did}</p>
              </div>
              <div>
                <p className="text-xs text-gray-400 uppercase tracking-wide">Duration</p>
                <p className="font-medium text-gray-900 mt-0.5">{call.duration}</p>
              </div>
              <div>
                <p className="text-xs text-gray-400 uppercase tracking-wide">Route</p>
                <p className="font-medium text-gray-900 mt-0.5">{call.agent}</p>
              </div>
            </div>
          </div>
        ))}
